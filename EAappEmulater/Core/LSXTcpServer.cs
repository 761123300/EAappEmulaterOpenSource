...
public static class LSXTcpServer
{
    ...
    static LSXTcpServer()
    {
        ...
        for (int i = 0; i <= 30; i++)
        {
            ...
            // 头像 \AppData\Local\Origin\AvatarsCache
    ...
    private static async Task<string> LSXRequestHandleForBFV(string request, string contentId)
    {
        ...
        return requestType switch
        {
            ...
            {
                "198387" => ScoketMsgBFV[27].Replace("##ID##", id).Replace("##UID##", Account.UserId),
                "16426154" => ScoketMsgBFV[28].Replace("##ID##", id).Replace("##UID##", Account.UserId),
               // "16426154_beta" => ScoketMsgBFV[28].Replace("##ID##", id).Replace("##UID##", Account.UserId),
                _ => ScoketMsgBFV[21].Replace("##ID##", id).Replace("##UID##", Account.UserId),
            },
            ...
            "><GetSettings version=" => ScoketMsgBFV[29].Replace("##ID##", id),
            _ => string.Empty,
        };
    }
